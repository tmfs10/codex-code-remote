...
console.log('🚀 Starting Codex Code Remote Multi-Platform Webhook Server...\n');
...
if (processes.length === 0) {
    console.log('❌ No platforms enabled. Please configure at least one platform in ~/.codex_code_remote_env:');
