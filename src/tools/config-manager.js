/**
 * Codex-Code-Remote Configuration Manager
...
class ConfigurationManager {
    ...
    async configureRelay() {
        ...
        console.log('Will support sending commands via notification channels and auto-executing in Codex');
    ...
    async configureEmailChannel() {
        ...
        const fromEmail = await this.question(`Sender display name (default: Codex-Code-Remote <${smtpUser}>): `);
        ...
        const newEmailConfig = {
            ...
            config: {
                ...
                from: fromEmail || `Codex-Code-Remote <${smtpUser || currentUser}>`,
