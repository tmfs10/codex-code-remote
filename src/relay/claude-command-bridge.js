/**
 * Command Bridge
 * Bridge for communicating with Codex CLI via file system
 */
...
class ClaudeCommandBridge {
    ...
    async sendCommand(command, sessionId) {
        try {
            ...
            // Create notification file (Codex can monitor this file for changes)
