...
# 
# Please copy the command below to Codex for execution:
        ...
        try {
            if (process.platform === 'darwin') {
                ...
                const script = `
                    ...
                    display notification "Command copied to clipboard, please paste to Codex" with title "TaskPing - New Email Command" subtitle "${shortCommand.replace(/"/g, '\\"')}" sound name "default"
                ...
                const script = `
                    try
                        tell application "System Events"
                            ...
                            if frontApp contains "Terminal" or frontApp contains "iTerm" or frontApp contains "Code" or frontApp contains "Codex" or frontApp contains "Claude" then
