 ...
 * Send commands to Codex via clipboard and keyboard automation
 */
...
class ClipboardAutomation {
    ...
    /**
     * Send command to Codex (via clipboard)
    ...
    async sendCommand(command) {
        try {
            ...
            // Step 2: Activate Codex and paste
            ...
            if (success) {
                ...
                this.logger.warn('Failed to activate Codex, trying fallback');
    ...
    /**
     * Activate Codex and paste command
     */
        ...
        return new Promise((resolve) => {
            const script = `
                tell application "System Events"
                    -- Try to find Codex or related applications
                    set targetApps to {"Codex", "OpenAI Codex", "Claude Code", "Terminal", "iTerm2", "iTerm", "Visual Studio Code", "Code", "Cursor"}
                    ...
                    if foundApp is not null then
                        ...
                        try
                            ...
                            if appName is "Codex" or appName is "OpenAI Codex" or appName is "Claude Code" then
                                -- Codex/Claude specific handling
