 ...
 * Tests the new terminal-style email template with long Codex responses
 */

const path = require('path');
const os = require('os');
require('dotenv').config({
    path: process.env.CODEX_CODE_REMOTE_ENV || path.join(os.homedir(), '.codex_code_remote_env')
});
...
`;
    ...
    const testNotification = {
        ...
        message: 'Testing terminal-style email with long Codex response',
