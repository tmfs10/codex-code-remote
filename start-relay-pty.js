...
/**
 * Codex-Code-Remote PTY Relay Startup Script
...
function checkConfig() {
    ...
    if (!fs.existsSync(envPath)) {
        console.error('❌ Error: ~/.codex_code_remote_env configuration file not found');
        console.log('\nPlease first copy .env.example to ~/.codex_code_remote_env and configure your email information:');
        console.log('  cp .env.example ~/.codex_code_remote_env');
        console.log('  Then edit ~/.codex_code_remote_env to fill in your email configuration\n');
        process.exit(1);
    }
    ...
    if (missing.length > 0) {
        ...
        console.log('\nPlease edit ~/.codex_code_remote_env and fill in all required configurations\n');
        process.exit(1);
    }
    ...
    if (!fs.existsSync(sessionMapPath)) {
        ...
        const exampleSession = {
            [exampleToken]: {
                ...
                cwd: process.cwd(),
                description: 'Test session - Include [Codex-Code-Remote #TEST123] in email subject when sending'
            }
        };
        ...
        console.log('   When sending test email, include in subject: [Codex-Code-Remote #TEST123]');
        console.log('');
    }
}
...
function startService() {
    ...
    console.log('🚀 Starting Codex-Code-Remote PTY Relay service...\n');
...
function showInstructions() {
    ...
    console.log('1. When executing tasks in Codex, reminder emails containing Token will be sent');
    ...
    console.log('     ```');
    console.log('4. System will automatically extract commands and inject them into corresponding Codex session');
...
function main() {
    console.log('╔══════════════════════════════════════════════════════════╗');
    console.log('║         Codex-Code-Remote PTY Relay Service               ║');
